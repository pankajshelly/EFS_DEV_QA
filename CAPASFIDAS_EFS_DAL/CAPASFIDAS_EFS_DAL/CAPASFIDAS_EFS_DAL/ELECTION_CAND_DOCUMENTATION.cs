...
namespace CAPASFIDAS_EFS_DAL
{
    ...
    public partial class ELECTION_CAND_DOCUMENTATION
    {
        public int ELECT_CAND_DOC_ID { get; set; }
        public Nullable<long> PET_ID { get; set; }
        public long ELECT_CAND_ID { get; set; }
        public int ELECT_CAND_VOLUME { get; set; }
        public string ELECT_CAND_PAGES { get; set; }
