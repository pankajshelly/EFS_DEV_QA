...
{
    public class ContributionRefundedSchedMController : Controller
    {
        ...
        #region ContributionRefundedSchedM
        /// <summary>
        /// ContributionRefundedSchedM
        /// </summary>
        /// <returns></returns>
        //
        // GET: /ContributionRefundedSchedM/
        public ActionResult ContributionRefundedSchedM()
        {
            try
            {
                ...
                return View("ContributionRefundedSchedM");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "ContributionRefundedSchedMController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
            
        }
        #endregion ContributionRefundedSchedM

        #region SaveContributionseRefundedData
        /// <summary>
        /// SaveContributionseRefundedData
        /// </summary>
        ...
        /// <returns></returns>        
        [HttpPost]
        public JsonResult SaveContributionseRefundedData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            String lstUCOfficeType, String lstDisclosurePeriod, String lstElectionType, String lstElectionDate, String strTransNumberOrg,
            String lstTransactionType, String txtDateRcvd, String txtContributorName, String txtCountry, String txtStreetName, String txtCity,
            ...
            String txtAmountRefunded, String txtExplanationRefunded, String lstElectionDateId, String txtCuttOffDate, String chkCountry, String lstFilingDate, String txtReportPeriodDatesTo, String lstResigTermType, String lstUCMuncipality)
        {
            try
            {
                ...
                #region FORM SERVER SIDE VALIDATION FOR SCHEDULE M.                       
                ...
                #endregion FORM SERVER SIDE VALIDATION FOR SCHEDULE M.
                ...
                if (ModelState.IsValid)
                {
                    ...
                    objFilingTransactionsModel.TransNumberOrg = strTransNumberOrg;
                    ...
                    var results = objItemizedReportsBroker.AddContributionsRefundedSchedMResponse(objFilingTransactionsModel);
        ...
        #endregion SaveContributionseRefundedData

        #region UpdateContributionsRefunded
        /// <summary>
        /// UpdateContributionsRefunded
        /// </summary>
        /// <param name="strFilingTransId"></param>
        ...
        /// <returns></returns>        
        [HttpPost]
        public JsonResult UpdateContributionsRefunded(String strTransNumber, String strFilingEntId,
            String txtDateRcvd, String txtContributorName, String txtCountry, String txtStreetName, String txtCity,
            ...
            String txtAmountRefunded, String txtExplanationRefunded, String txtCuttOffDate, String chkCountry, String lstFilingDate, String txtReportPeriodDatesTo, String lstResigTermType, String lstElectionType)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    Boolean results = objItemizedReportsBroker.UpdateContributionsRefundedSchedMResponse(objFilingTransactionsModel);
        ...
        #endregion UpdateContributionsRefunded
        ...
        #region GetContributorOrginalAmount
        /// <summary>
        /// GetContributorOrginalAmount
        /// </summary>
        /// <param name="strFilingEntityId"></param>
        /// <returns></returns>
        public JsonResult GetContributorOrginalAmount(String strFilingEntityId)
        {
            try
            {
                ...
                lstExpPaymentOriginalAmountModel = objItemizedReportsBroker.GetContributorOriginalAmountResponse(strFilingEntityId, strFilerId);
        ...
        #endregion GetContributorOrginalAmount

        #region GetContributorOriginalContributionDate
        /// <summary>
        /// GetContributorOriginalContributionDate
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult GetContributorOriginalContributionDate(String strFilingEntityId, String strOriginalAmt)
        {
            try
            {
                ...
                lstExpPaymentOriginalExpenseDateModel = objItemizedReportsBroker.GetContributorOriginalContributionDateResponse(strFilingEntityId, strOriginalAmt, strFilerId);
        ...
        #endregion GetContributorOriginalContributionDate

        #region GetOutstandingContrRefundedAmt
        /// <summary>
        /// GetOutstandingContrRefundedAmt
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult GetOutstandingContrRefundedAmt(String strTransNumber, String strFilerId)
        {
            try
            {
                String strOutstandingAmountRefunded = objItemizedReportsBroker.GetOutstaningAmtContrRefundedResponse(strTransNumber, strFilerId);
        ...
        #endregion GetOutstandingContrRefundedAmt

        #region GetOriginalAmountContrTransIdUpdate
        /// <summary>
        /// GetOriginalAmountContrTransIdUpdate
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult GetOriginalAmountContrTransIdUpdate(String strTransNumber)
        {
            try
            {
                IList<ExpPaymentOriginalAmountModel> lstExpPaymentOriginalAmountModel = new List<ExpPaymentOriginalAmountModel>();

                lstExpPaymentOriginalAmountModel = objItemizedReportsBroker.GetOriginalAmtRefundedSchedMResponse(strTransNumber, Session["FilerId"].ToString());
        ...
        #endregion GetOriginalAmountContrTransIdUpdate      
        ...
        #region GetContributionOriginalName
        /// <summary>
        /// GetContributionOriginalName
        /// </summary>
        /// <param name="strFilerId"></param>
        /// <returns></returns>
        public JsonResult GetContributionOriginalName(String strFilerId)
        {
            try
            {
                ...
                lstExpPaymentOriginalNameModelSelect = objItemizedReportsBroker.GetContributorOriginalNameResponse(strFilerId);
        ...
        #endregion GetContributionOriginalName

        #region GetScheduleMHelpPopUp
        /// <summary>
        /// GetScheduleAHelpPopUp
        /// </summary>
        /// <returns></returns>
        public ActionResult GetScheduleMHelpPopUp()
        {
            return View("GetScheduleMHelpPopUp");
        }
        #endregion GetScheduleMHelpPopUp
        ...
        public void GetDefaultLookUpsValues()
        {
            ...
            lstExpPaymentOriginalNameModel.Add(objExpPaymentOriginalNameModel);
            if (Session["FilerId"] != null)
                lstExpPaymentOriginalNameModelSelect = objItemizedReportsBroker.GetContributorOriginalNameResponse(Session["FilerId"].ToString());
            else
                lstExpPaymentOriginalNameModelSelect = objItemizedReportsBroker.GetContributorOriginalNameResponse("");
            ...
            // Bind Original Name.
            ViewData["lstContributorName"] = new SelectList(lstExpPaymentOriginalNameModel, "FilingEntityId", "FilingEntityName");
            IList<ExpPaymentOriginalAmountModel> lstExpPaymentOriginalAmountModel = new List<ExpPaymentOriginalAmountModel>();
            ViewData["lstContributorAmount"] = new SelectList(lstExpPaymentOriginalAmountModel, "FilingTransId", "OriginalAmount");
            IList<ExpPaymentOriginalExpenseDateModel> lstExpPaymentOriginalExpenseDateModel = new List<ExpPaymentOriginalExpenseDateModel>();
            ViewData["lstContributorDate"] = new SelectList(lstExpPaymentOriginalExpenseDateModel, "FilingTransId", "OriginalExpenseDate");
