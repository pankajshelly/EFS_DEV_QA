...
{
    public class NonItemIE24HContributionSchedAController : Controller
    {
        ...
        #region NonItemIE24HContributionSchedA
        /// <summary>
        /// NonItemIE24HContributionSchedA
        /// </summary>
        /// <returns></returns>
        // GET: NonItemIE24HContributionSchedA
        public ActionResult NonItemIE24HContributionSchedA()
        {
            try
            {
                ...
                return View("NonItemIE24HContributionSchedA");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIE24HContributionSchedAController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemIE24HContributionSchedA

        #region SaveNonItemIE24HContrSchedAData
        /// <summary>
        /// SaveNonItemIE24HContrSchedAData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIE24HContrSchedAData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            ...
            String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmt24HNotice, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String txtReportPeriodDatesTo, String chkCountry)
        {
            try
            {
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Contribution Schedule 'A'.
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Contribution Schedule 'A'.
        ...
        #endregion SaveNonItemIE24HContrSchedAData                

        #region UpdateNonItemIE24HContrSchedAData
        /// <summary>
        /// UpdateNonItemIE24HContrSchedAData
        /// </summary>
        ...
        #endregion UpdateNonItemIE24HContrSchedAData        

        #region SubmitNonItemIE24HContrSchedAData
        /// <summary>
        /// SubmitNonItemIE24HContrSchedAData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult SubmitNonItemIE24HContrSchedAData(String strTransNumber)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
        ...
        #endregion SubmitNonItemIE24HContrSchedAData

        #region DeleteNonItemIE24HContrSchedA
        /// <summary>
        /// DeleteNonItemIE24HContrSchedA
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItemIE24HContrSchedA(String strTransNumber)
        {
            try
            {
                String strModifiedBy = Session["UserName"].ToString(); // "SBasireddy"; //Testing only
        ...
        #endregion DeleteNonItemIE24HContrSchedA
