...
{
    public class NonItemIEWeeklyContributionSchedDController : Controller
    {
        ...
        #region NonItemIEWeeklyContributionSchedD
        /// <summary>
        /// NonItemIEWeeklyContributionSchedD
        /// </summary>
        /// <returns></returns>
        // GET: NonItemIEWeeklyContributionSchedD
        public ActionResult NonItemIEWeeklyContributionSchedD()
        {
            try
            {
                ...
                return View("NonItemIEWeeklyContributionSchedD");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIEWeeklyContributionSchedDController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemIEWeeklyContributionSchedD

        #region SaveNonItemIEWeeklyContrSchedDData
        /// <summary>
        /// SaveNonItemIEWeeklyContrSchedDData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIEWeeklyContrSchedDData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            String lstUCOfficeType, String lstElectionType, String lstElectionDate, String lstElectionDateId,
            String lstTransactionTypeNonItem, String txtCurrentDate24HNotice, String lstContributionName, String lstContributionType, String txtPartnerShipName, String txtFirstName, String txtMI, String txtLastName, String txtCountry, String txtStreetName, String txtCity,
            String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmt24HNotice, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String lstFilingDate, String txtReportPeriodDatesTo, String chkCountry, String lstUCMuncipality)
        {
            try
            {
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure Weekly Contribution Schedule 'D'.
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure Weekly Contribution Schedule 'D'.
        ...
        #endregion SaveNonItemIEWeeklyContrSchedDData                

        #region UpdateNonItemIEWeeklyContrSchedDData
        /// <summary>
        /// UpdateNonItemIEWeeklyContrSchedDData
        /// </summary>
        ...
        #endregion UpdateNonItemIEWeeklyContrSchedDData        

        #region SubmitNonItemIEWeeklyContrSchedDData
        /// <summary>
        /// SubmitNonItemIEWeeklyContrSchedDData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult SubmitNonItemIEWeeklyContrSchedDData(String strTransNumber)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
        ...
        #endregion SubmitNonItemIEWeeklyContrSchedDData

        #region DeleteNonItemIEWeeklyContrSchedD
        /// <summary>
        /// DeleteNonItemIEWeeklyContrSchedD
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItemIEWeeklyContrSchedD(String strTransNumber)
        {
            try
            {
                String strModifiedBy = Session["UserName"].ToString(); // "SBasireddy"; //Testing only
        ...
        #endregion DeleteNonItemIEWeeklyContrSchedD
