...
{
    public class NonItemizedTransactionSchedCController : Controller
    {
        ...
        #region NonItemizedTransactionSchedC
        /// <summary>
        /// NonItemizedTransactionSchedC
        /// </summary>
        /// <returns></returns>
        // GET: NonItemizedTransactionSchedC
        public ActionResult NonItemizedTransactionSchedC()
        {
            try
            {
                ...
                return View("NonItemizedTransactionSchedC");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemizedTransactionSchedCController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemizedTransactionSchedC
        ...
        public JsonResult UpdateNonItem24HourNoticeSchedAData(String strTransNumber,
            ...
            String txtAmt24HNotice, String txtExplanation, String txtPartnerShipName,
            String txtCountry, String txtStreetName, String txtCity, String txtState, String txtZipCode, String lstElectionType, String lstFilingDate, String txtReportPeriodDatesTo, String txtCuttOffDate, String chkCountry)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
        ...
        /// </summary>
        /// <returns></returns>
        public JsonResult GetContributorCodeSchedA() // CONTRIBUTOR TYPE CODE FOR SCHEDULE 'C'.
        {
            try
            {
