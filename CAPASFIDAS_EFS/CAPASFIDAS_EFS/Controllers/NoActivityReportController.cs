/*
 * =====================================================================
 * PAGE NAME: NO ACTIVITY REPORT (NON-ITEMIZED TRANSACTIONS EFS)
...
{
    public class NoActivityReportController : Controller
    {
        ...
        #region NoActivityReport
        // GET: NoActivityReport
        public ActionResult NoActivityReport()
        {
            try
            {
                ...
                return View("NoActivityReport");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NoActivityReportController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NoActivityReport

        #region GetNoActivityReport
        /// <summary>
        /// GetNoActivityReport
        /// </summary>
        ...
        /// <returns></returns>
        public JsonResult GetNoActivityReport(String txtFilerID, String lstElectionDate, String lstElectionType, String lstUCOfficeType,
            String lstDisclosurePeriod, String lstDisclosureType, String lstElectionCycle, String strElectionYear, String lstFilingDate, String txtFilingDate)
        {
            try
            {
                ...
                lstInLieuOfStatementNonItemModel = objItemizedReportsBroker.GetNoActivityReporttDataResponse(txtFilerID, lstElectionDate,
        ...
        #endregion GetNoActivityReport

        #region AddNoActivityReportData
        /// <summary>
        /// AddNoActivityReportData
        /// </summary>
        /// <param name="txtFilerID"></param>
        /// <param name="lstElectionDate"></param>
        /// <param name="lstElectionType"></param>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult AddNoActivityReportData(String txtFilerID, String lstElectionDate,
            ...
            String lstUCCounty, String lstUCMuncipality, String lstResigTermType, String lstElectionDateId, String lstFilingDate, String txtReportPeriodDatesTo)
        {
            try
            {
                ...
                if (lstResigTermType != null)
                {
                    if (lstResigTermType != "")
                    {
                        if (lstResigTermType != "0")
                        {
                            Boolean results = objItemizedReportsBroker.GetDropdownValueExistsResponse("RESIGNATION_TERMINATION_TYPE", lstResigTermType.ToString());
                            if (!results)
                            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    objAddInLieuOfStatementModel.ResigTermTypeId = lstResigTermType;
                    ...
                    var results = objItemizedReportsBroker.AddNoActivityReportResponse(objAddInLieuOfStatementModel);
        ...
        #endregion AddNoActivityReportData
