...
{
    public class _UC_Address_TreasurerController : Controller
    {
        ...
        // GET: _UC_Address_Treasurer
        public ActionResult _UC_Address_Treasurer()
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "_UC_Address_TreasurerController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
