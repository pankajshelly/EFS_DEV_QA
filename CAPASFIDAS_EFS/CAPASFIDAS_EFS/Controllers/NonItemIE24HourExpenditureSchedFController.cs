...
{
    public class NonItemIE24HourExpenditureSchedFController : Controller
    {
        ...
        // GET: NonItemIE24HourExpenditureSchedF
        public ActionResult NonItemIE24HourExpenditureSchedF()
        {
            try
            {
                ...
                return View("NonItemIE24HourExpenditureSchedF");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIE24HourExpenditureSchedFController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }

        #region SaveNonItemIE24HourExpSchedFData
        /// <summary>
        /// SaveNonItemIE24HourExpSchedFData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIE24HourExpSchedFData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId, String lstUCOfficeType, String lstElectionType, String lstElectionDate, String lstElectionDateId, String lstTransactionTypeNonItem, String txtCurrentDate24HNotice, String lstPurposeCode, String txtPayeeName, String txtCountry, String txtStreetName, String txtCity, String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmtIEWeeklyExpenditure, String txtOutstandingAmt, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String lstLiability, String lstLiabilityExists, String lstSubcontractor, String lstDateIncurred, String lstFilingDate, String txtReportPeriodDatesTo, String txtCuttOffDate, String chkCountry)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var results = objItemizedReportsBroker.AddNonItemIE24HourExpFlngTransResponse(objFilingTransactionsModel);
        ...
        #endregion SaveNonItemIE24HourExpSchedFData                
