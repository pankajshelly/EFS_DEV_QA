/*
 * =====================================================================
 * PAGE NAME: 24-HOUR NOTICE (SCHEDULE B TRANSACTIONS).
...
{
    public class NonItemizedTransactionSchedBController : Controller
    {
        ...
        #region NonItemizedTransactionSchedB
        /// <summary>
        /// NonItemizedTransactionSchedB
        /// </summary>
        /// <returns></returns>
        // GET: NonItemizedTransactionSchedB
        public ActionResult NonItemizedTransactionSchedB()
        {
            try
            {
                ...
                return View("NonItemizedTransactionSchedB");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemizedTransactionSchedBController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemizedTransactionSchedB
        ...
        public JsonResult UpdateNonItem24HourNoticeSchedAData(String strTransNumber,
            String strFilingEntId, String strSubmissionDate, String lstTransactionTypeNonItem,
            ...
            String txtCountry, String txtStreetName, String txtCity, String txtState,
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItem24HourNoticeSchedA(String strTransNumber, String filerID)
        {
            try
            {
                String strModifiedBy = Session["UserName"].ToString(); // "SBasireddy"; //Testing only
