...
{
    public class NonItemIEWeeklyContributionSchedCController : Controller
    {
        ...
        #region NonItemIEWeeklyContributionSchedC
        /// <summary>
        /// NonItemIEWeeklyContributionSchedC
        /// </summary>
        /// <returns></returns>
        // GET: NonItemIEWeeklyContributionSchedC
        public ActionResult NonItemIEWeeklyContributionSchedC()
        {
            try
            {
                ...
                return View("NonItemIEWeeklyContributionSchedC");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIEWeeklyContributionSchedCController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemIEWeeklyContributionSchedC

        #region SaveNonItemIEWeeklyContrSchedCData
        /// <summary>
        /// SaveNonItemIEWeeklyContrSchedCData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIEWeeklyContrSchedCData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            ...
            String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmt24HNotice, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String lstFilingDate, String txtReportPeriodDatesTo, String chkCountry, String lstUCMuncipality)
        {
            try
            {
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure Weekly Contribution Schedule 'C'.
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure Weekly Contribution Schedule 'C'.
        ...
        #endregion SaveNonItemIEWeeklyContrSchedCData                

        #region UpdateNonItemIEWeeklyContrSchedCData
        /// <summary>
        /// UpdateNonItemIEWeeklyContrSchedCData
        /// </summary>
        ...
        #endregion UpdateNonItemIEWeeklyContrSchedCData        

        #region SubmitNonItemIEWeeklyContrSchedCData
        /// <summary>
        /// SubmitNonItemIEWeeklyContrSchedCData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>        
        public JsonResult SubmitNonItemIEWeeklyContrSchedCData(String strTransNumber)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
        ...
        #endregion SubmitNonItemIEWeeklyContrSchedCData

        #region DeleteNonItemIEWeeklyContrSchedC
        /// <summary>
        /// DeleteNonItemIEWeeklyContrSchedC
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItemIEWeeklyContrSchedC(String strTransNumber)
        {
            try
            {
                String strModifiedBy = Session["UserName"].ToString(); // "SBasireddy"; //Testing only
        ...
        #endregion DeleteNonItemIEWeeklyContrSchedC
