...
{
    public class DRSummery_AsTRTypeController : Controller
    {
        ...
        // GET: DRSummery_AsTRType
        public ActionResult DRSummery_AsTRType()
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "DRSummery_AsTRTypeController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
