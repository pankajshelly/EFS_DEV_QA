/*
 * =====================================================================
 * PAGE NAME: INDEPENDENT EXPENDITURE - 24 HOUR EXPENDITURE - PIDA
...
{
    public class NonItemIE24HourPIDAExpenditureSchedFController : Controller
    {
        ...
        // GET: NonItemIE24HourPIDAExpenditureSchedF
        public ActionResult NonItemIE24HourPIDAExpenditureSchedF()
        {
            try
            {
                ...
                return View("NonItemIE24HourPIDAExpenditureSchedF");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIE24HourPIDAExpenditureSchedF", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }            
        }

        #region SaveNonItemIE24HourPIDAExpSchedFData
        /// <summary>
        /// SaveNonItemIE24HourPIDAExpSchedFData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIE24HourPIDAExpSchedFData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId, String lstUCOfficeType, String lstElectionType, String lstElectionDate, String lstElectionDateId, String lstTransactionTypeNonItem, String txtCurrentDate24HNotice, String lstPurposeCode, String txtPayeeName, String txtCountry, String txtStreetName, String txtCity, String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmtIEWeeklyExpenditure, String txtOutstandingAmt, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String lstLiability, String lstLiabilityExists, String lstSubcontractor, String lstDateIncurred, String lstFilingDate, String txtReportPeriodDatesTo, String txtCuttOffDate, String chkCountry)
        {
            try
            {
                // DEFINE FILINGTRANSACTIONSMODEL OBJECT
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Expenditure
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Expenditure

                if (ModelState.IsValid)
                {
                    // ASSING VALUES INTO OBJECT
                    ...
                    // CALL BORKER METHOD TO ADD THE IE 24 HOUR EXPENDITURE TRANSACTION DATA.
                    var results = objItemizedReportsBroker.AddNonItemIE24HourPIDAExpFlngTransResponse(objFilingTransactionsModel);

                    // RETURN THE SUCCESS/FAIL AS JSON RESULT.
        ...
        #endregion SaveNonItemIE24HourPIDAExpSchedFData                

        #region UpdateNonItemIE24HourExpSchedFData
        /// <summary>
        /// UpdateNonItemIE24HourExpSchedFData
        /// </summary>
        ...
        public JsonResult UpdateNonItemIE24HourExpSchedFData(String strTransNumber, String strFilingEntId, String lstPurposeCode, String strSubmissionDate, String lstTransactionTypeNonItem, String txtCurrentDate24HNotice, String txtCheck, String lstMethod, String txtAmtIEWeeklyExpenditure, String txtOutstandingAmt, String txtExplanation, String txtPayeeName, String txtCountry, String txtStreetName, String txtCity, String txtState, String txtZipCode, String strTreasId, String strAddrId, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtIndependentExpenditureDescription, String txtTreasurerOccupation, String txtTreasurerEmployer, String lstSupported, String txtCandidateNameBPReference, String lstSubcontractor, String lstLiability, String lstDateIncurred, String lstElectionType, String lstFilingDate, String txtReportPeriodDatesTo, String txtCuttOffDate, String chkCountry)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    // CALL BORKER METHOD TO UPDATE THE IE 24 HOUR EXPENDITURE TRANSACTION DATA.
        ...
        #endregion UpdateNonItemIE24HourExpSchedFData        

        #region SubmitNonItemIE24HourExpSchedFData
        /// <summary>
        /// SubmitNonItemIE24HourExpSchedFData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult SubmitNonItemIE24HourExpSchedFData(String strTransNumber)
        {
            try
            {
                // DEFINE FILINGTRANSACTIONSMODEL OBJECT
                ...
                if (ModelState.IsValid)
                {
                    ...
                    // CALL THE SUBMIT BROKER METHOD TO SUBMIT IE 24 HOUR EXPENDITURE TRANSACTION.
                    ...
                    // GET THE RESULT AND RETURN AS JSON RESULT WITH SUCCESS/FAIL.
                    if (results)
                    {
        ...
        #endregion SubmitNonItemIE24HourExpSchedFData
        ...
        public JsonResult DeleteNonItemIEWeeklyContrSchedF(String strTransNumber)
        {
            try
            {
                ...
                // CALL THE DELETE BROKER METHOD TO DELETE THE IE 24 HOUR EXPENDITURE TRANSACTION.
                ...
                // RETURN THE RESULT AS A JSON RESULT SUCCESS/FAIL.
                return Json(results, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GetPaymentMethodData()
        {
            try
            {
                // DEFINE THE PAYMENTMETHODMODEL OBJECT
                ...
                // GET THE PAYMENT METHOD VALUES TO CALL BROKER METHOD TO GET DATA.
                ...
                // RETURN THE JSON RESULT TO BIND PAYMENT METHOD VALUES.
        ...
        public JsonResult GetPurposeCodeSchedF()
        {
            try
            {
                // DEFINE THE MODEL OBJECT TO BIND THE PURPOSE CODE VALUES.
                ...
                // CALL THE BROKER METHOD TO GET THE PURPOSE CODE VALUES.
                ...
                // RETURN THE JSON RESULTS TO BIND THE PURPOSE CODE.
        ...
        public JsonResult GetChildTransExists(String strTransNumber)
        {
            try
            {
                // CALL THE BROKER METHOD TO GET THE CHILD TRANSACTIONS EXISTS OR NOT.
                Boolean results = objItemizedReportsBroker.GetNonItemChildTransExistsResponse(strTransNumber, Session["FilerID"].ToString());
                // RETURN JSON RESULTS CHILD TRANSACTIONS EXISTS OR NOT.
                return Json(results, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GetAutoCompleteNameData(String strValue)
        {
            try
            {
                ...
                // GET THE RESULTS LIST FROM MODEL USING FILING ENTITY ID.
        ...
        #region GetIE24HourExpTreasurerData
        /// <summary>
        /// GetIE24HourExpTreasurerData
        /// </summary>
        /// <returns></returns>
        public JsonResult GetIE24HourExpTreasurerData()
        {
            try
            {
                // DEFINE MODEL OBJECT.
        ...
        #endregion GetIE24HourExpTreasurerData
        ...
        public JsonResult GetDateIncurredUpdate(String strTransNumber)
        {
            try
            {
                ...
                lstDateIncurredModel = objItemizedReportsBroker.GetNonItemIEDateIncrdLiabUpdateDataResponse(strTransNumber);
                ...
                foreach (var item in lstDateIncurredModel)
                {
                    ...
                    {
                        item.OrginalDate = item.DateIncurredValue;
                        item.DateIncurredValue = item.DateIncurredValue.Trim() + " - " + "$" + item.AmountLiability;
                    }
                }
        ...
        #region GetSortNameSchedFIENonItem
        /// <summary>
        /// GetSortNameSchedFIENonItem
        /// </summary>
        /// <returns></returns>
        public JsonResult GetSortNameSchedFIENonItem()
        {
            try
            {
        ...
        #endregion GetSortNameSchedFIENonItem
