/*
 * =====================================================================
 * PAGE NAME: Public Fund Repayment (SCHEDULE U TRANSACTIONS).
 * AUTHOR NAME: Pankaj Agarwal
 * CREATED DATE: 01/19/2023
 * UPDATED BY:
 * UPDATED DATE:
 * =========================================================================
 * 
...
{
    public class PublicFundRepaymentSchedUController : Controller
    {
        ...
        // GET: PublicFundRepaymentSchedU
        public ActionResult PublicFundRepaymentSchedU()
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "PublicFundRepaymentSchedUController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }
                throw;
            }
        }
        ...
        /// <summary>
        /// GetReportSourceDataSchedU
        /// </summary>
        /// <returns></returns>
        public JsonResult GetReportSourceDataSchedU()
        {
        ...
        /// <returns></returns>
        public JsonResult AddPublicFundRepaymentSchedUData(String txtFilerId, String strFilingSchedDate, String PaymentTypeId,
            ...
            String txtReportPeriodDatesTo, String electionDateId, String lstResigTermType, String txtCuttOffDate)
        {
            try
            {
                ...
                {
                    ModelState.AddModelError("txtDateRefundPaid", "Date of Refund Paid is required");
                }
                else if (!objCommonErrorsServerSide.DateUS(strFilingSchedDate))
                {
                    ModelState.AddModelError("txtDateRefundPaid", "Enter valid date format (MM/DD/YYYY)");
                }
                ...
                else if (strElectionTypeId == "6")
                {
                    if (strFilingDate == "- New Filing Date -")
                    {
                        ...
                        {
                            ModelState.AddModelError("txtDateRefundPaid", "Date of Refund Paid cannot be later than Cut Off Date");
                        }
                    }
                    else
                    {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    results = objItemizedReportsBroker.AddPublic_Fund_Payment_SchedU_Broker(objFilingTransactionsModel);
        ...
        /// <param name="strTransExplanation"></param>
        /// <returns></returns>
        public JsonResult UpdatePublicFundRepaymentSchedUData(String txtFilerId, String transNumber, String strFilingSchedDate, String PaymentTypeId,
                                                        String strPayNumber, String strOrgAmt, String strTransExplanation)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    objFilingTransactionsModel.TransExplanation = strTransExplanation;
                    objFilingTransactionsModel.CreatedBy = Session["UserName"].ToString();
                    var results = objItemizedReportsBroker.UpdateFlngtrans_PublicFundPayment_Broker(objFilingTransactionsModel);
