...
{ 
    public class NonItemIEWeeklyContributionSchedBController : Controller
    {
        ...
        #region NonItemIEWeeklyContributionSchedB
        /// <summary>
        /// NonItemIEWeeklyContributionSchedB
        /// </summary>
        /// <returns></returns>
        // GET: NonItemIEWeeklyContributionSchedB
        public ActionResult NonItemIEWeeklyContributionSchedB()
        {
            try
            {
                ...
                return View("NonItemIEWeeklyContributionSchedB");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIEWeeklyContributionSchedBController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemIEWeeklyContributionSchedB

        #region SaveNonItemIEWeeklyContrSchedBData
        /// <summary>
        /// SaveNonItemIEWeeklyContrSchedBData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIEWeeklyContrSchedBData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            ...
            String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmt24HNotice, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String lstFilingDate, String txtReportPeriodDatesTo, String chkCountry, String lstUCMuncipality)
        {
            try
            {
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure Weekly Contribution Schedule 'B'.
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure Weekly Contribution Schedule 'B'.
        ...
        #endregion SaveNonItemIEWeeklyContrSchedBData                

        #region UpdateNonItemIEWeeklyContrSchedBData
        /// <summary>
        /// UpdateNonItemIEWeeklyContrSchedBData
        /// </summary>
        ...
        #endregion UpdateNonItemIEWeeklyContrSchedBData        

        #region SubmitNonItemIEWeeklyContrSchedBData
        /// <summary>
        /// SubmitNonItemIEWeeklyContrSchedBData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult SubmitNonItemIEWeeklyContrSchedBData(String strTransNumber)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
        ...
        #endregion SubmitNonItemIEWeeklyContrSchedBData

        #region DeleteNonItemIEWeeklyContrSchedB
        /// <summary>
        /// DeleteNonItemIEWeeklyContrSchedB
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItemIEWeeklyContrSchedB(String strTransNumber)
        {
            try
            {
                String strModifiedBy = Session["UserName"].ToString(); // "SBasireddy"; //Testing only
        ...
        #endregion DeleteNonItemIEWeeklyContrSchedB
