...
{
    public class NonItemIE24HContributionSchedDController : Controller
    {
        ...
        #region NonItemIE24HContributionSchedD
        /// <summary>
        /// NonItemIE24HContributionSchedD
        /// </summary>
        /// <returns></returns>
        // GET: NonItemIE24HContributionSchedD
        public ActionResult NonItemIE24HContributionSchedD()
        {
            try
            {
                ...
                return View("NonItemIE24HContributionSchedD");
            }
            ...
            catch (Exception ex)
            {
                ...
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIE24HContributionSchedDController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemIE24HContributionSchedD

        #region SaveNonItemIE24HContrSchedDData
        /// <summary>
        /// SaveNonItemIE24HContrSchedDData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIE24HContrSchedDData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            ...
            String txtState, String txtZipCode, String lstContributionType, String lstMethod, String txtCheck, String txtAmt24HNotice, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String txtReportPeriodDatesTo, String chkCountry)
        {
            try
            {
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Contribution Schedule 'D'.
                ...
                else if (!objCommonErrorsServerSide.CuttOffDateValidation(txtCurrentDate24HNotice, txtReportPeriodDatesTo))
                {
                ...
                //}
                if (lstContributionName != "5" && lstContributionName != "6" && lstContributionName != "7" && lstContributionName != "9" && lstContributionName != "10" && lstContributionName != "12" && lstContributionName != "11" && lstContributionName != "13" && lstContributionName != "14")
                {
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Contribution Schedule 'D'.
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var results = objItemizedReportsBroker.AddNonItemIE24HContrFlngTransResponse(objFilingTransactionsModel);
        ...
        #endregion SaveNonItemIE24HContrSchedDData                

        #region UpdateNonItemIE24HContrSchedDData
        /// <summary>
        /// UpdateNonItemIE24HContrSchedDData
        /// </summary>
        ...
        public JsonResult UpdateNonItemIE24HContrSchedDData(String strTransNumber, String strFilingEntId, String lstContributorName, String strSubmissionDate, String lstTransactionTypeNonItem, String txtCurrentDate24HNotice, String txtCheck, String lstMethod, String lstContributionType, String txtAmt24HNotice, String txtExplanation, String txtPartnerShipName, String txtFirstName, String txtMI, String txtLastName, String txtCountry, String txtStreetName, String txtCity, String txtState, String txtZipCode, String strTreasId, String strAddrId, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtTreasurerOccupation, String txtTreasurerEmployer, String lstSupported, String txtCandidateNameBPReference, String chkCountry)
        {
            try
            {
                ...
                //    ModelState.AddModelError("lstSupported", "Invalid Is Supoorted");
                //}
                if (lstContributorName != "5" && lstContributorName != "6" && lstContributorName != "7" && lstContributorName != "9" && lstContributorName != "10" && lstContributorName != "12" && lstContributorName != "11" && lstContributorName != "13" && lstContributorName != "14")
                {
                    if (txtContributorOccupation != "")
                    {
                        if (!objCommonErrorsServerSide.NameValidate(txtContributorOccupation))
                ...
                if (ModelState.IsValid)
                {
                    ...
                    Boolean results = objItemizedReportsBroker.UpdateIE24HContrFlngTransResponse(objFilingTransactionsModel);
        ...
        #endregion UpdateNonItemIE24HContrSchedDData        

        #region SubmitNonItemIE24HContrSchedDData
        /// <summary>
        /// SubmitNonItemIE24HContrSchedDData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult SubmitNonItemIE24HContrSchedDData(String strTransNumber)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
                ...
                Boolean results = objItemizedReportsBroker.SubmitIE24HContrFlngTransResponse(strTransNumber, strModifiedBy);
        ...
        #endregion SubmitNonItemIE24HContrSchedDData

        #region DeleteNonItemIE24HContrSchedD
        /// <summary>
        /// DeleteNonItemIE24HContrSchedD
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItemIE24HContrSchedD(String strTransNumber)
        {
            try
            {
        ...
        #endregion DeleteNonItemIE24HContrSchedD
        ...
        #region GetContributorCodeSchedD
        /// <summary>
        /// GetContributorCodeSchedD
        /// </summary>
        /// <returns></returns>
        public JsonResult GetContributorCodeSchedD()
        {
            try
            {
                ...
                var resContributorType = objItemizedReportsBroker.GetContributorCodeIEWeeklyContrSchedDRespnse();
        ...
        #endregion GetContributorCodeSchedD
        ...
        #region GetIE24HContrbutionTreasurerData
        /// <summary>
        /// GetIE24HContrbutionTreasurerData
        /// </summary>
        /// <returns></returns>
        public JsonResult GetIE24HContrbutionTreasurerData()
        {
            try
            {
        ...
        #endregion GetIE24HContrbutionTreasurerData
        ...
        public JsonResult GetIETransactionsHistory(String strTransNumber)
        {
            try
            {
                ...
                lstFilingTransactionDataModel = objItemizedReportsBroker.GetFilingTransIE24HContributionHistoryDataResponse(strTransNumber);
        ...
        public void GetDefaultLookUpsValues()
        {
            ...
            lstTransactionTypeModel = objItemizedReportsBroker.GetIE24HContrTransactionTypesResponse(); ; //GetTransactionTypeData();
            ...
            ViewData["lstContributionNameSchedD"] = new SelectList(lstContributorNameModel, "ContributorTypeId", "ContributorTypeDesc");
            ...
            lstSortColumnName = objItemizedReportsBroker.GetViewableColumnsBroker(Session["FilerID"].ToString(), "EFS", "IE-24HourContribution");
