...
{
    public class NonItemIE24HContributionSchedIController : Controller
    {
        ...
        #region NonItemIE24HContributionSchedI
        /// <summary>
        /// NonItemIE24HContributionSchedI
        /// </summary>
        /// <returns></returns>
        // GET: NonItemIE24HContributionSchedI
        public ActionResult NonItemIE24HContributionSchedI()
        {
            try
            {
                ...
                return View("NonItemIE24HContributionSchedI");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIE24HContributionSchedIController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemIE24HContributionSchedI

        #region SaveNonItemIE24HContrSchedIData
        /// <summary>
        /// SaveNonItemIE24HContrSchedIData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIE24HContrSchedIData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            ...
            String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmt24HNotice, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String txtReportPeriodDatesTo, String chkCountry)
        {
            try
            {
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Contribution Schedule 'I'.
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Contribution Schedule 'I'.
        ...
        #endregion SaveNonItemIE24HContrSchedIData                

        #region UpdateNonItemIE24HContrSchedIData
        /// <summary>
        /// UpdateNonItemIE24HContrSchedIData
        /// </summary>
        ...
        #endregion UpdateNonItemIE24HContrSchedIData        

        #region SubmitNonItemIE24HContrSchedIData
        /// <summary>
        /// SubmitNonItemIE24HContrSchedIData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult SubmitNonItemIE24HContrSchedIData(String strTransNumber)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
        ...
        #endregion SubmitNonItemIE24HContrSchedIData

        #region DeleteNonItemIE24HContrSchedI
        /// <summary>
        /// DeleteNonItemIE24HContrSchedI
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItemIE24HContrSchedI(String strTransNumber)
        {
            try
            {
                String strModifiedBy = Session["UserName"].ToString(); // "SBasireddy"; //Testing only
        ...
        #endregion DeleteNonItemIE24HContrSchedI
