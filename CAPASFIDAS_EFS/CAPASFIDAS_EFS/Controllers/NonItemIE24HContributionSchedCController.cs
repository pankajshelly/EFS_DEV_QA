...
{
    public class NonItemIE24HContributionSchedCController : Controller
    {
        ...
        #region NonItemIE24HContributionSchedC
        /// <summary>
        /// NonItemIE24HContributionSchedC
        /// </summary>
        /// <returns></returns>
        // GET: NonItemIE24HContributionSchedC
        public ActionResult NonItemIE24HContributionSchedC()
        {
            try
            {
                ...
                return View("NonItemIE24HContributionSchedC");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIE24HContributionSchedCController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemIE24HContributionSchedC

        #region SaveNonItemIE24HContrSchedCData
        /// <summary>
        /// SaveNonItemIE24HContrSchedCData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIE24HContrSchedCData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            ...
            String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmt24HNotice, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String txtReportPeriodDatesTo, String chkCountry)
        {
            try
            {
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Contribution Schedule 'C'.
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure 24 Hour Contribution Schedule 'C'.
        ...
        #endregion SaveNonItemIE24HContrSchedCData                

        #region UpdateNonItemIE24HContrSchedCData
        /// <summary>
        /// UpdateNonItemIE24HContrSchedCData
        /// </summary>
        ...
        #endregion UpdateNonItemIE24HContrSchedCData        

        #region SubmitNonItemIE24HContrSchedCData
        /// <summary>
        /// SubmitNonItemIE24HContrSchedCData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult SubmitNonItemIE24HContrSchedCData(String strTransNumber)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
        ...
        #endregion SubmitNonItemIE24HContrSchedCData

        #region DeleteNonItemIE24HContrSchedC
        /// <summary>
        /// DeleteNonItemIE24HContrSchedC
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItemIE24HContrSchedC(String strTransNumber)
        {
            try
            {
                String strModifiedBy = Session["UserName"].ToString(); // "SBasireddy"; //Testing only
        ...
        #endregion DeleteNonItemIE24HContrSchedC
        ...
        #region GetContributorCodeSchedC
        /// <summary>
        /// GetContributorCodeSchedC
        /// </summary>
        /// <returns></returns>
        public JsonResult GetContributorCodeSchedC()
        {
            try
            {
                ...
                var resContributorNames = objItemizedReportsBroker.GetContributorCodeIEWeeklyContrSchedCResponse();
                foreach (var item in resContributorNames)
                {
                    if (item != null)
                    {
                        if (item.ContributorTypeId != "8")
                        {
                            objContributorNameModel = new ContributorNameModel();
        ...
        #endregion GetContributorCodeSchedC
