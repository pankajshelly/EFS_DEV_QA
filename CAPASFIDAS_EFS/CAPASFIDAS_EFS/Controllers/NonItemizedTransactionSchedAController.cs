...
{
    public class NonItemizedTransactionSchedAController : Controller
    {
        ...
        #region NonItemizedTransactionSchedA
        /// <summary>
        /// NonItemizedTransactionSchedA
        /// </summary>
        /// <returns></returns>
        // GET: NonItemizedTransactionSchedA
        public ActionResult NonItemizedTransactionSchedA()
        {
            try
            {
                ...
                return View("NonItemizedTransactionSchedA");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemizedTransactionSchedAController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemizedTransactionSchedA
        ...
        public JsonResult GetContributorCodeSchedA()
        {
            try
            {
                ...
                if (itemToRemove != null)
                    resContributorNames.Remove(itemToRemove);
                itemToRemove = resContributorNames.SingleOrDefault(x => x.ContributorTypeId == "11");
                if (itemToRemove != null)
                    resContributorNames.Remove(itemToRemove);
                itemToRemove = resContributorNames.SingleOrDefault(x => x.ContributorTypeId == "13");
                if (itemToRemove != null)
                    resContributorNames.Remove(itemToRemove);
                itemToRemove = resContributorNames.SingleOrDefault(x => x.ContributorTypeId == "14");
                if (itemToRemove != null)
                    resContributorNames.Remove(itemToRemove);
                itemToRemove = resContributorNames.SingleOrDefault(x => x.ContributorTypeId == "12");
                if (itemToRemove != null)
                    resContributorNames.Remove(itemToRemove);
