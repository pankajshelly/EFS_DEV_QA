/*
 * =====================================================================
 * PAGE NAME: 24-HOUR NOTICE (SCHEDULE D TRANSACTIONS).
...
{
    public class NonItemizedTransactionSchedDController : Controller
    {
        ...
        #region NonItemizedTransactionSchedD
        /// <summary>
        /// NonItemizedTransactionSchedD
        /// </summary>
        /// <returns></returns>
        // GET: NonItemizedTransactionSchedD
        public ActionResult NonItemizedTransactionSchedD()
        {
            try
            {
                ...
                return View("NonItemizedTransactionSchedD");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemizedTransactionSchedDController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemizedTransactionSchedD
        ...
        public JsonResult SaveNonItem24HourNoticeSchedAData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId,
            ...
            String txtState, String txtZipCode, String lstContributionType, String lstMethod, String txtCheck, String txtAmt24HNotice, String txtExplanation, String lstItemized, String lstElectionDateId, String lstFilingDate, String txtReportPeriodDatesTo, String txtCuttOffDate, String chkCountry)
        {
            try
            {
        ...
        public JsonResult UpdateNonItem24HourNoticeSchedAData(String strTransNumber,
            String strFilingEntId, String lstContributorName, String strSubmissionDate, String lstTransactionTypeNonItem,
             String txtCurrentDate24HNotice, String txtCheck, String lstMethod, String lstContributionType,
            ...
            try
            {
                ...
                if (lstContributorName != null)
                {
                    if (lstContributorName != "")
                    {
                        ...
                        {
                            Boolean results = objItemizedReportsBroker.GetDropdownValueExistsResponse("CONTRIBUTOR_TYPE", lstContributorName.ToString());
                            if (!results)
                            {
                                ModelState.AddModelError("lstContributionName", "Invalid Contributor Code");
                            }
        ...
        public JsonResult SubmitNonItem24HourNoticeSchedAData(String txtFilerId, String strTransNumber,
            String strFilingEntId, String lstTransactionTypeNonItem, String lstContributionType,
        ...
        public void GetDefaultLookUpsValues()
        {
            ...
            IList<ContributionTypeModel> lstContributionTypeModel = new List<ContributionTypeModel>();
            IList<ContributionTypeModel> lstContributionTypeModelResults = new List<ContributionTypeModel>();
            ContributionTypeModel objContributionTypeModel;
            objContributionTypeModel = new ContributionTypeModel();
            objContributionTypeModel.ContributionTypeId = "0";
            objContributionTypeModel.ContributionTypeDesc = "- Select -";
            objContributionTypeModel.ContributionTypeAbbrev = "SEL";
            lstContributionTypeModel.Add(objContributionTypeModel);
            lstContributionTypeModelResults = objItemizedReportsBroker.GetContributionTypeDataResponse();
            foreach (var item in lstContributionTypeModelResults)
            {
                if (item != null)
                {
                    objContributionTypeModel = new ContributionTypeModel();
            ...
            // Bind Contribution Type
            ViewData["lstContributionTypeNonItemD"] = new SelectList(lstContributionTypeModel, "ContributionTypeId", "ContributionTypeDesc");
