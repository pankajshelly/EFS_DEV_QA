...
{
    public class NonItemIEWeeklyLiabilityIncurredSchedNController : Controller
    {
        ...
        #region NonItemIEWeeklyLiabilityIncurredSchedN
        /// <summary>
        /// NonItemIEWeeklyLiabilityIncurredSchedN
        /// </summary>
        /// <returns></returns>
        // GET: NonItemIEWeeklyLiabilityIncurredSchedN
        public ActionResult NonItemIEWeeklyLiabilityIncurredSchedN()
        {
            try
            {
                ...
                return View("NonItemIEWeeklyLiabilityIncurredSchedN");
            }
            catch (Exception ex)
            {
                if (Session["UserName"] != null)
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "NonItemIEWeeklyLiabilityIncurredSchedNController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
        }
        #endregion NonItemIEWeeklyLiabilityIncurredSchedN

        #region SaveNonItemIEWeeklyLiabIncrSchedNData
        /// <summary>
        /// SaveNonItemIEWeeklyLiabIncrSchedNData
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SaveNonItemIEWeeklyLiabIncrSchedNData(String txtFilerId, String lstElectionCycle, String lstElectionCycleId, String lstUCOfficeType, String lstElectionType, String lstElectionDate, String lstElectionDateId, String lstTransactionTypeNonItem, String txtCurrentDate24HNotice, String lstPurposeCode, String txtPayeeName, String txtCountry, String txtStreetName, String txtCity, String txtState, String txtZipCode, String lstMethod, String txtCheck, String txtAmtIEWeeklyExpenditure, String txtOutstandingAmt, String txtExplanation, String txtTreasurerOccupation, String txtTreasurerEmployer, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtCandidateNameBPReference, String lstSupported, String lstFilingDate, String txtReportPeriodDatesTo, String chkCountry, String lstUCMuncipality)
        {
            try
            {
                ...
                #region Form Server Side Validation Non-Itemized Independent Expenditure Weekly Contribution Schedule 'N'.
                ...
                //{
                //    if (!objCommonErrorsServerSide.ValidateAlphaNumericAddress(txtContributorOccupation))
                //    {
                ...
                //{
                //    if (!objCommonErrorsServerSide.ValidateAlphaNumericAddress(txtContributorEmployer))
                //    {
                ...
                #endregion Form Server Side Validation Non-Itemized Independent Expenditure Weekly Contribution Schedule 'N'.
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var results = objItemizedReportsBroker.AddNonItemIEWeeklyLiabIncrFlngTransResponse(objFilingTransactionsModel);
        ...
        #endregion SaveNonItemIEWeeklyLiabIncrSchedNData                

        #region UpdateNonItemIEWeeklyLiabIncrSchedNData
        /// <summary>
        /// UpdateNonItemIEWeeklyLiabIncrSchedNData
        /// </summary>
        ...
        /// <param name="txtCheck"></param>
        /// <param name="lstMethod"></param>
        /// <param name="txtAmtIEWeeklyExpenditure"></param>
        /// <param name="txtOutstandingAmt"></param>
        /// <param name="txtExplanation"></param>
        /// <param name="txtPayeeName"></param>
        /// <param name="txtCountry"></param>
        /// <param name="txtStreetName"></param>
        /// <param name="txtCity"></param>
        /// <param name="txtState"></param>
        ...
        public JsonResult UpdateNonItemIEWeeklyLiabIncrSchedNData(String strTransNumber, String strFilingEntId, String lstPurposeCode, String strSubmissionDate, String lstTransactionTypeNonItem, String txtCurrentDate24HNotice, String txtCheck, String lstMethod, String txtAmtIEWeeklyExpenditure, String txtOutstandingAmt, String txtExplanation, String txtPayeeName, String txtCountry, String txtStreetName, String txtCity, String txtState, String txtZipCode, String strTreasId, String strAddrId, String txtStreetNameTreasurer, String txtCityTreasurer, String txtStateTreasurer, String txtZipCodeTreasurer, String txtContributorOccupation, String txtContributorEmployer, String txtIndependentExpenditureDescription, String txtTreasurerOccupation, String txtTreasurerEmployer, String lstSupported, String txtCandidateNameBPReference, String chkCountry)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    Boolean results = objItemizedReportsBroker.UpdateIEWeeklyLiabIncrFlngTransResponse(objFilingTransactionsModel);
        ...
        #endregion UpdateNonItemIEWeeklyLiabIncrSchedNData        

        #region SubmitNonItemIEWeeklyLiabIncrSchedNData
        /// <summary>
        /// SubmitNonItemIEWeeklyLiabIncrSchedNData
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        public JsonResult SubmitNonItemIEWeeklyLiabIncrSchedNData(String strTransNumber)
        {
            try
            {
                FilingTransactionsModel objFilingTransactionsModel = new FilingTransactionsModel();
        ...
        #endregion SubmitNonItemIEWeeklyLiabIncrSchedNData

        #region DeleteNonItemIEWeeklyLiabIncrSchedN
        /// <summary>
        /// DeleteNonItemIEWeeklyLiabIncrSchedN
        /// </summary>
        /// <param name="strFilingTransId"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult DeleteNonItemIEWeeklyLiabIncrSchedN(String strTransNumber)
        {
            try
            {
                String strModifiedBy = Session["UserName"].ToString(); // "SBasireddy"; //Testing only
        ...
        #endregion DeleteNonItemIEWeeklyLiabIncrSchedN
        ...
        public JsonResult GetIETransactionsHistory(String strTransNumber)
        {
            try
            {
                ...
                lstFilingTransactionDataModel = objItemizedReportsBroker.GetFilingTransIEWeeklyLiabIncrHistoryDataResponse(strTransNumber);
        ...
        #region GetPurposeCodeLiabIncrSchedN
        /// <summary>
        /// GetPurposeCodeLiabIncrSchedN
        /// </summary>
        /// <returns></returns>
        public JsonResult GetPurposeCodeLiabIncrSchedN()
        {
            try
            {
                ...
                var resPurposeCoeds = objItemizedReportsBroker.GetNonItemIESchedNPurposeCodesResponse();
        ...
        #endregion GetPurposeCodeLiabIncrSchedN
        ...
        public void GetDefaultLookUpsValues()
        {
            ...
            lstTransactionTypeModel = objItemizedReportsBroker.GetIEWeeklyLiabInccrTransactionTypesResponse(); ; //GetTransactionTypeData();
            ...
            lstSortColumnName = objItemizedReportsBroker.GetViewableColumnsBroker(Session["FilerID"].ToString(), "EFS", "IE-WeeklyLiabilityIncurred");
