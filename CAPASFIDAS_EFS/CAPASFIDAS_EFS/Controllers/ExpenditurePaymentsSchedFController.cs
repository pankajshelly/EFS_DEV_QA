...
{
    public class ExpenditurePaymentsSchedFController : Controller
    {
        ...
        public ActionResult ExpenditurePaymentsSchedF()
        {
            try
            {
                ...
                return View("ExpenditurePaymentsSchedF");
            }
            catch (Exception ex)
            {
        ...
        public JsonResult DeleteFilingTransactions(String strLoanLiabNumberOrg, String strTransNumber, String strRLiability)
        {
            try
            {
                ...
                Boolean results = objItemizedReportsBroker.DeleteFlngTransExpPaySchedFNDataResponse(strLoanLiabNumberOrg, strTransNumber, strRLiability, strModifiedBy, Session["FilerId"].ToString(),"");
        ...
        public JsonResult GetReimbursementData(String strTransNumberReimb)
        {
            try
            {
                ...
                lstFilingTransactionsModel = objItemizedReportsBroker.GetFlngTransExpReimbursementDataResponse(strTransNumberReimb, strFilerId,"");
        ...
        public JsonResult GetCreditCardItemizationData(String strFilingTransIdCreditCardItem)
        {
            try
            {
                ...
                lstFilingTransactionsModel = objItemizedReportsBroker.GetFlngTransExpReimbursementDataResponse(strFilingTransIdCreditCardItem, strFilerId, "");
        ...
        public JsonResult ExpenditureRefundSchedLExists(String strTransNumber)
        {
            try
            {
                String results = objItemizedReportsBroker.GetExpPaymentExistsSchedLResponse(strTransNumber, Session["FilerID"].ToString(),"");
        ...
        public void GetDefaultLookUpsValues()
        {
            try
            {
                ...
                ViewData["lstSuppOrOpps"] = new SelectList(lstLiability, "strLiabilityId", "strLiabilityName", 1);
