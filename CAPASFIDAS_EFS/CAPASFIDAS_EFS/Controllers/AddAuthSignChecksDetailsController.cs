...
{
    public class AddAuthSignChecksDetailsController : Controller
    {
        ...
        //
        // GET: /AddAuthSignChecksDetails/
        public ActionResult AddAuthSignChecksDetails()
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "AddAuthSignChecksDetailsController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }
                throw;
            }
