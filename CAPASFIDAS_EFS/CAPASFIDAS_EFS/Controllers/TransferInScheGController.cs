...
{
    public class TransferInScheGController : Controller
    {
        ...
        //
        // GET: /TransferInScheG/
        public ActionResult TransferInScheG()
        {
            try
            {
        ...
        /// <returns></returns>
        public JsonResult AddTransferInScheduledData(String txtFilerId, String strFilingSchedId, String strTransferTypeId, String strFilingSchedDate,
            ...
            String txtCuttOffDate, String lstUCMuncipality)
        {
            try
            {
                ...
                if (strFlngEntName == "")
                {
                    ModelState.AddModelError("txtTransferorName", "Transferor Name is required");
                }
                ...
                {
                    objFilingTransactionsModel.FilerId = txtFilerId;
                    objFilingTransactionsModel.FilingSchedId = "7";
                    ...
                    results = objItemizedReportsBroker.AddFilingTransaction_TransferIn_Broker(objFilingTransactionsModel);
        ...
        /// <param name="PaymentTypeId"></param>
        /// <returns></returns>
        public JsonResult UpdateTransferInScheduledData(String strTransferTypeId, String strFilingSchedDate,
            ...
            String txtPartZip, String txtCountry, String chkCountry, String transNumber, String PaymentTypeId, String lstOfficeTypeId, String lstFilingTypeId,
            String lstElectYearId, String txtFilerId, String strFilingDate, String txtReportPeriodDatesTo, String electionDateId, String lstResigTermType,
            String txtCuttOffDate)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    objFilingTransactionsModel.OrgAmt = strOrgAmt;
                    objFilingTransactionsModel.TransExplanation = strTransExplanation;
                    objFilingTransactionsModel.ElectionTypeId = "P";
                    ...
                    var results = objItemizedReportsBroker.UpdateFilingTransaction_TransferIn_Broker(objFilingTransactionsModel);
        ...
        #region GetScheduleGHelpPopUp
        /// <summary>
        /// GetScheduleAHelpPopUp
        /// </summary>
        /// <returns></returns>
        public ActionResult GetScheduleGHelpPopUp()
        {
            return View("GetScheduleGHelpPopUp");
        }
        #endregion GetScheduleGHelpPopUp
