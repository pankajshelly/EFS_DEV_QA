...
{
    public class DRSummery_ByScheduleController : Controller
    {
        ...
        // GET: DRSummery_BySchedule
        public ActionResult DRSummery_BySchedule()
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    objERClass.LogExceptionInDatabase(ConfigurationManager.AppSettings["ApplicationKey"].ToString(), ex.Message, "DRSummery_ByScheduleController", System.Reflection.MethodBase.GetCurrentMethod().Name, "", "", ex.Message, Session["UserName"].ToString());
                }                
                throw;
            }
