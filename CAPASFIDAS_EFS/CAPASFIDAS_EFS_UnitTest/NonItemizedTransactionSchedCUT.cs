...
{
    [TestClass]
    public class NonItemizedTransactionSchedCUT
    {
        private NonItemizedTransactionSchedCUT()
        {
            //
        ...
        {
            var controller = new NonItemizedTransactionSchedCController();

            var result = controller.NonItemizedTransactionSchedC() as ViewResult;

            Assert.AreEqual("NonItemizedTransactionSchedC", result.ViewName.ToString());
        }
        ...
        public void SaveNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.SaveNonItem24HourNoticeSchedAData(data.FilerId, data.ElectionYear, data.ElectYearId,
                ...
                data.ContributorTypeId, data.FlngEntName, data.FlngEntCountry, data.FlngEntStrName, data.FlngEntCity, data.FlngEntState, data.FlngEntZip, data.PaymentTypeId, data.PayNumber, data.OrgAmt, data.TransExplanation, data.RItemized, "", "", "", "", "");
        ...
        public void SubmitNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.SubmitNonItem24HourNoticeSchedAData(data.FilerId, data.FilingTransId, data.FilingEntId, data.FilingSchedId,
                data.SchedDate, data.ContributorTypeId, data.PayNumber, data.PaymentTypeId, data.OrgAmt, data.TransExplanation, data.ElectionYear,
