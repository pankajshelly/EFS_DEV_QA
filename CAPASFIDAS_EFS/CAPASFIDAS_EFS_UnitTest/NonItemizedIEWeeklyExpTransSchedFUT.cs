...
{
    [TestClass]
    public class NonItemizedIEWeeklyExpTransSchedFUT
    {        
        public NonItemizedIEWeeklyExpTransSchedFUT()
        {
            //
            // TO DO;
            //
        ...
        public void NonItemIEWeeklyExpenditureSchedF_UnitTest()
        {
            ...
            var result = controller.NonItemIEWeeklyExpenditureSchedF() as ViewResult;

            Assert.AreEqual("NonItemIEWeeklyExpenditureSchedF", result.ViewName.ToString());
        }
        ...
        public void SubmitNonItemIEWeeklyContrSchedFData_UnitTest()
        {
            ...
            var results = controller.SubmitNonItemIEWeeklyContrSchedFData(strFilingTransId);
