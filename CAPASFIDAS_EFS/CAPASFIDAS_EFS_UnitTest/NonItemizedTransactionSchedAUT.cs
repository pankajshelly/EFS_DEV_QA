...
{
    [TestClass]
    public class NonItemizedTransactionSchedAUT
    {
        private NonItemizedTransactionSchedAUT()
        {
            //
        ...
        /// </summary>
        [TestMethod]
        public void NonItemizedTransactionSchedA_UnitTest()
        {
            var controller = new NonItemizedTransactionSchedAController();

            var result = controller.NonItemizedTransactionSchedA() as ViewResult;

            Assert.AreEqual("NonItemizedTransactionSchedA", result.ViewName.ToString());
        }
        ...
        public void SaveNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.SaveNonItem24HourNoticeSchedAData(data.FilerId, data.ElectionYear, data.ElectYearId,
                ...
                data.ContributorTypeId, data.FlngEntName, data.FlngEntFirstName, data.FlngEntMiddleName, data.FlngEntLastName,
        ...
        public void UpdateNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.UpdateNonItem24HourNoticeSchedAData(data.FilingTransId, data.FilingEntId, data.ContributorTypeId,
                ...
                data.TransExplanation, data.FlngEntName, data.FlngEntFirstName, data.FlngEntMiddleName, data.FlngEntLastName, data.FlngEntCountry,
                data.FlngEntStrName, data.FlngEntCity, data.FlngEntState, data.FlngEntZip, "", "", "", "", "");
        ...
        public void SubmitNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.SubmitNonItem24HourNoticeSchedAData(data.FilerId, data.FilingTransId, data.FilingEntId, data.FilingSchedId,
                data.ContributorTypeId, data.SchedDate, data.PayNumber, data.PaymentTypeId, data.OrgAmt, data.TransExplanation, data.ElectionYear,
