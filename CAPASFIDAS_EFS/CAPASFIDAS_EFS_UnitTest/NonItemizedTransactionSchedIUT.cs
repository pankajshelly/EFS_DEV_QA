...
{
    [TestClass]
    public class NonItemizedTransactionSchedIUT
    {
        private NonItemizedTransactionSchedIUT()
        {
            //
        ...
        {
            var controller = new NonItemizedTransactionSchedIController();

            var result = controller.NonItemizedTransactionSchedI() as ViewResult;

            Assert.AreEqual("NonItemizedTransactionSchedI", result.ViewName.ToString());
        }
        ...
        public void SaveNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.SaveNonItem24HourNoticeSchedAData(data.FilerId, data.ElectionYear, data.ElectYearId,
                ...
                data.ContributorTypeId, data.FlngEntName, data.FlngEntFirstName, data.FlngEntMiddleName, data.FlngEntLastName, data.FlngEntCountry, data.FlngEntStrName, data.FlngEntCity, data.FlngEntState, data.FlngEntZip, data.PaymentTypeId, data.PayNumber, data.OrgAmt, data.TransExplanation, data.RItemized, "", "", "", "", "");
