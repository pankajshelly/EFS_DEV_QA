...
{
    [TestClass]
    public class NonItemizedTransactionSchedBUT
    {

        private NonItemizedTransactionSchedBUT()
        {
            //
        ...
        {
            var controller = new NonItemizedTransactionSchedBController();

            var result = controller.NonItemizedTransactionSchedB() as ViewResult;

            Assert.AreEqual("NonItemizedTransactionSchedB", result.ViewName.ToString());
        }
        ...
        public void SaveNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.SaveNonItem24HourNoticeSchedAData(data.FilerId, data.ElectionYear, data.ElectYearId,
                ...
                data.FlngEntName, data.FlngEntCountry, data.FlngEntStrName, data.FlngEntCity, data.FlngEntState, data.FlngEntZip, data.PaymentTypeId, data.PayNumber, data.OrgAmt, data.TransExplanation, data.RItemized, "", "", "", "", "");
        ...
        public void UpdateNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.UpdateNonItem24HourNoticeSchedAData(data.FilingTransId, data.FilingEntId,
                data.SubmissionDate, data.FilingSchedId, data.SchedDate, data.PayNumber, data.PaymentTypeId, data.OrgAmt,
                data.TransExplanation, data.FlngEntName, data.FlngEntCountry, data.FlngEntStrName, data.FlngEntCity,
                data.FlngEntState, data.FlngEntZip, "", "", "", "", "");
        ...
        public void SubmitNonItem24HourNoticeSchedAData_UnitTest()
        {
            ...
            var results = controller.SubmitNonItem24HourNoticeSchedAData(data.FilerId, data.FilingTransId, data.FilingEntId, data.FilingSchedId,
                data.SchedDate, data.PayNumber, data.PaymentTypeId, data.OrgAmt, data.TransExplanation, data.ElectionYear,
                data.ElectYearId, data.OfficeTypeId, data.FilingTypeId, data.ElectionTypeId, data.ElectionDate, "", "", "", "");
